<?php
// This gets copied into ./Elgg/elgg-config/settings.php before install.
 ...
 */
$CONFIG->dataroot = "/var/data/elgg-data/";
 ...
 */
$port = '8081';
if (!empty($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] === '8082') {
	$port = '8082';
}
$CONFIG->wwwroot = "http://localhost:{$port}/";
unset($port);
